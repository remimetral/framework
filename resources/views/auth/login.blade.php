...
@section('title'){{ strip_tags(ucfirst(Lang::get('meta.title.login'))) }}@stop

@section('content')

    <input class="page_title" type="hidden" value="{{ strip_tags(ucfirst(Lang::get('meta.title.login'))) }}">
                                    ...
                                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                ...
                                                <a class="btn btn-link ajax" href="{{ route('password.request') }}">
