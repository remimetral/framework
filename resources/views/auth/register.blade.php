...
@section('title'){{ strip_tags(ucfirst(Lang::get('meta.title.register'))) }}@stop

@section('content')

    <input class="page_title" type="hidden" value="{{ strip_tags(ucfirst(Lang::get('meta.title.register'))) }}">
